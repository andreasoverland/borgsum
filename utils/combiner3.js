...
let minNumMasterLines   = 10000000;
...
let moreMasterLinesAvailable = true;x
let numLinesRead = 0;
let uniqueLines = 0;
let numKeys = 0;
...
function readNextMasterLinesFromNextFile(){
	...
	// now we are ready to scan every file with the contents in theMap, and rewrite each file afterwards with a
/*
	try {
